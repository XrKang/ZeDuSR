...
def gen_kernel(k_size, scale_factor, min_var, max_var):
    ...
    LAMBDA = np.diag([lambda_1, lambda_1])
    SIGMA = LAMBDA
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='./WideView_GT',
                        help='HR image path')
    parser.add_argument('--save_path', type=str, default=r'./WideView_iso2x',
                        help='LR image save path')
    parser.add_argument('--kernel_path', type=str, default=r'./kernel_WideView_iso2x',
    ...
    parser.add_argument('--kernel_size', type=int, default=21, help='kernel size')

    parser.add_argument('--min_var', type=float, default=0.2, help='min_var')
    parser.add_argument('--max_var', type=float, default=2.0, help='max_var')

    parser.add_argument('--noise_level', type=float, default=0.0, help='noise_level')
    ...
    noise_level = 0.0  # this option allows deviation from just a gaussian, by adding multiplicative noise noise
